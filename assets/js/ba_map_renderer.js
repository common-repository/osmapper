...
//						   console.log("Couldn't recieve response")
    ...
    function renderCustomMap(mapID, settings) {
        ...
        var tileLayer = new L.TileLayer(settings.config.scheme + '/{z}/{x}/{y}.png', {
            attribution: '<a href="https://www.b4after.pl">Agencja SEO Poznań </a>&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
        });
...
//		map.addControl(new L.Control.Fullscreen());
    ...
    function renderMap(markers, config, xhrOptions) {
        ...
        let tileLayer = new L.TileLayer(mapScheme + '{z}/{x}/{y}.png', {
            attribution: '<a href="https://www.b4after.pl/osmapper?utm_source=' + window.location.href + '&utm_medium=map_contributors&utm_campaign=OSMapper">Agencja SEO Poznań</a> &copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
        });
